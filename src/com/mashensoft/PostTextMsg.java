...
public class PostTextMsg {
	public static void main(String[] args) {
		...
		String str = "https://api.weixin.qq.com/cgi-bin/getcallbackip?access_token=5_gXPdKXvFI_yKj4jWMa_P81IF1qlnnxVineOAoKcso6RU0RSI0DaAXTpqq1JlmYMIphpwia-PZknSKfzT5Iphs-1JlD8ieJvLfBbigbKzsEaaUo2STDJqY_BA1MesGFxdCnHhNJTf1O2xRjT4ZXMhAJASQF";
		URL url;
		try {
			url = new URL(str);
